...
## Published 0.4.4 pin — 2026-09-25 (Asia/Tashkent)

Version 0.4.4 was published before this pin update. The [publication receipt](../evidence/releases/0.4.4/publication.json)
records green source CI on `b62f3f930ea54400c1ad2d7edc173af9d01bee68`, all release jobs,
matching GitHub/PyPI hashes and the fresh no-cache public installation smoke.
The public wheel SHA-256 is `1babb29e96d5f0bc8f0f31673e831a6da72d9fd50f137d2e0c94774acb50db8e`.
...
**ooxml-integrity 0.4.4 · Pyodide 314.0.6**. Chromium
153.0.8010.12, Playwright 1.63.0 and Node v24.3.0 were used.
[Browser receipt](../evidence/releases/0.4.4/demo-pin.json) includes actual runtime/Doctor
